...
public class NewTester {
    ...
    void execute() throws IOException, InterruptedException {
        ...
        args.add("-jar");
        args.add("/software/jira/software/ljar/skyview.jar");
    ...
    public void testCatalogs() throws Exception {
        ...
        if (test(false)) {
            ...
            String prefix = base.toString();
            test(false);
            assertTrue("tableexists", new File(prefix + ".tab").exists());
            long l1 = new File(prefix + ".tab").length();

            currentSettings.put("catalogradius", "5");
            String prefix2 = base.toString();
            test(false);
            long l2 = new File(prefix2 + ".tab").length();
            ...
            test(false);
            assertTrue("Create cat file", new File("mycat.file").exists());
        }
    }
